// Exercise database with form cues, muscle targets, and media placeholders
export const exerciseDB = {
  ...
  chest_press_incline: { 
    ...
    media: null // Placeholder for gif/image path
  },
  chest_press_flat_bb: { 
...
export const getExercise = (id) => exerciseDB[id] || { name: id, muscles: 'Unknown', cues: [] };
