...
export const exerciseDB = {
  ...
  lateral_raise_db: {
    ...
    media: require('../../training-fit-library/shoulders/lateral-raise.png')
  },
  lateral_raise_cable: {
  ...
  tricep_pushdown_rope: {
    ...
    media: require('../../training-fit-library/triceps/cable-tricep-pushdowns.png')
  },
  tricep_pushdown_bar: {
    name: 'Bar Pushdown',
    muscles: 'Triceps',
  ...
  tricep_overhead_cable: {
    ...
    media: require('../../training-fit-library/triceps/overhead-tricep-extension.png')
  },
  tricep_overhead_db: {
    name: 'Overhead Dumbbell Extension',
    muscles: 'Triceps long head',
    cues: ['Elbows close together', 'Full range of motion', 'Control weight', 'Deep stretch'],
    media: require('../../training-fit-library/triceps/dumbbell-tricep-extension.png')
  },
  tricep_skullcrusher: {
    name: 'Skull Crushers',
    muscles: 'Triceps',
  ...
  row_cable_seated: {
    ...
    media: require('../../training-fit-library/back/cable-row.png')
  },
  row_chest_supported: {
  ...
  curl_preacher: {
    ...
    media: require('../../training-fit-library/biceps/preacher-curls.png')
  },
  curl_cable: {
    name: 'Cable Curl',
    muscles: 'Biceps',
    cues: ['Constant tension', 'Elbows pinned', 'Full ROM', 'Squeeze peak'],
    media: require('../../training-fit-library/biceps/cable-curls.png')
  },
  curl_dumbbell: {
    name: 'Dumbbell Curl',
    muscles: 'Biceps',
  ...
  curl_hammer: {
    ...
    media: require('../../training-fit-library/biceps/hammer-curls.png')
  },
  curl_reverse: {
    name: 'Reverse Curl',
  ...
  cable_crunch: {
    ...
    media: require('../../training-fit-library/abs/cable-crunch.png')
  },
  hanging_knee_raise: {
    name: 'Hanging Knee Raise',
    muscles: 'Lower abs',
    cues: ['Tuck pelvis up', 'Control descent', 'No swinging', 'Full ROM'],
    media: require('../../training-fit-library/abs/hanging-knee-raise.png')
  },
  plank: {
    name: 'Plank',
    muscles: 'Core',
  ...
  squat_hack: {
    ...
    media: require('../../training-fit-library/legs/hack-squat.png')
  },
  squat_barbell: {
    name: 'Barbell Squat',
  ...
  leg_press: {
    ...
    media: require('../../training-fit-library/legs/seated-leg-press.png')
  },
  leg_extension: {
    name: 'Leg Extension',
    muscles: 'Quads',
    cues: ['Full lockout', 'Squeeze quads', 'Control negative', 'Stay seated'],
    media: require('../../training-fit-library/legs/leg-extensions.png')
  },
  ...
  rdl: {
    ...
    media: require('../../training-fit-library/back/dumbbell-romanian-deadlift.png')
  },
  rdl_dumbbell: {
    name: 'Dumbbell RDL',
    muscles: 'Hamstrings, glutes',
  ...
  leg_curl_lying: {
    ...
    media: require('../../training-fit-library/legs/lying-leg-curl.png')
  },
  leg_curl_seated: {
  ...
  hip_thrust: {
    ...
    media: require('../../training-fit-library/legs/hip-adduction.png')
  },
  glute_ham_raise: {
