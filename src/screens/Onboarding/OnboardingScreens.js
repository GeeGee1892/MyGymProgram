  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.footer}>
        <Button onPress={() => navigation.navigate('OnboardingStats')} disabled={!userData.name?.trim()}>Continue</Button>
      </View>
    </SafeAreaView>
  );
};
...
export const StatsScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.toggleRow}>
          {['male', 'female'].map((sex) => (
            <TouchableOpacity 
              ...
              onPress={() => setUserData({ gender: sex })}
            >
      ...
      <View style={styles.footer}>
        <Button onPress={() => navigation.navigate('OnboardingGoal')} disabled={!isValid}>Continue</Button>
      </View>
    </SafeAreaView>
  );
};
...
export const GoalScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.footer}>
        <Button onPress={() => navigation.navigate('OnboardingTrainingDays')} disabled={!userData.goal}>Continue</Button>
      </View>
    </SafeAreaView>
  );
};
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.tipCard}>
          <Text style={styles.tipText}><Text style={styles.tipHighlight}>Tip: </Text>3-4 days is optimal. Recovery matters.</Text>
        </View>
      </View>
      <View style={styles.footer}>
        <Button onPress={() => navigation.navigate('OnboardingPlanReady')} disabled={!userData.trainingDaysPerWeek}>Continue</Button>
      </View>
    </SafeAreaView>
  );
};
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.weightCard}>
          ...
          <Text style={styles.weightValue}>{userData.weight}kg → {userData.targetWeight}kg</Text>
        </View>
